...
.img-fluid {
  max-width: 100%; /*estava como max-width: 100%; |1400px */
  height: auto; /*estava como height: auto; | 550px*/
}
...
.card-img-top {
  width: 100%;  /* Estava: width: 100%; Daí alterei para 348px, mas coloquei novamente para width 100% 
  e não tinha height como atributo. */ 
  height: 200px; /*estava com 200px*/
...
.list-group-item {
  ...
  display: block;
  padding: 0.75rem 1.25rem;
  /* left: -60px; não havia nesse arquivo*/
  margin-bottom: -1px;
  background-color: #fff;
  border: 1px solid rgba(0, 0, 0, 0.125);
}
...
.list-group-item:focus, .list-group-item:hover {
  text-decoration: underline; /*estava como none*/
  cursor: pointer;
}
...
.close {
  ...
  font-weight: 700;
  line-height: 1; 
  color: black; /*antes era: #000*/
  text-shadow: 0 1px 0 #fff;
  opacity: 0.5;
}
.close:focus, .close:hover {
  color: white; /*antes era: #000*/
  background: #000; /*não tinha esse fundo */
  text-decoration: none;
  opacity: 0.75;
}
...
button.close {
  padding: 0;
  background: transparent; /* color que eu coloquei: rgb(100,100,100)*/
  border: 0;
  -webkit-appearance: none;
}
...
.carousel-inner {
  position: relative;
  overflow: hidden; /*
  max-width: 100%; /*nessa parte só havia width: 100%; 
  height: auto; */
}
